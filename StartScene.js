...
class StartScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text( 50, 140, `Welcome: ${gameState.playerName}`, { fontFamily: 'Georgia', fontSize: '30px', fill: '#800000' });
    ...
    this.add.text( 120, 310, '⬅️ key to move left', {fontFamily: 'Georgia', fill: '#800000', fontSize: '20px'})
    this.add.text( 120, 340, '➡️ key to move right', {fontFamily: 'Georgia', fill: '#800000', fontSize: '20px'})
